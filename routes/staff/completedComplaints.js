...
router.get('/:registerNo', async (req, res) => {
  try {
    ...
    // Find all complaints assigned to this staff that are completed
    ...
    .sort({ resolvedAt: -1, updatedAt: -1 }); // Most recent first
